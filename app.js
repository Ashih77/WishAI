...
const FALLBACK_GREETINGS = {
    ...
    'newyear': ['سنة جديدة سعيدة مليئة بالأفراح', 'كل عام وأنتم بخير بمناسبة العام الجديد', 'نتمنى لكم عاماً مشرقاً وناجحاً', 'بداية عام جميلة كجمال قلوبكم', 'أجمل الأماني بعام سعيد'],
